...
def run(args):
    """
    This function runs the comparisonn between RandomSearch and SMBO 
    for one dataset. Results are saved as 'comparison.png', 'PerformanceSMBO.png',
    and 'PerformanceRS.png' in the current folder.
    """  
    ...
    plt.grid(True)
    plt.savefig('PerformanceSMBO.png')
    plt.show()
